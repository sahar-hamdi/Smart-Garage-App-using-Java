...
a configurable maximum number of vehicles. Each parking space (slot) is defined with a dimension 
...
1- I Created Use Case Diagrams and Descriptions for this model 
2- Created Class and Sequence Diagrams and Descreptions 
3- Implemented Code Using Java
